...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    function SubmitBlock(blockHex, callback){
        ...
        _this.daemon.cmd(rpcCommand,
            ...
            function(results){
				...
				fs.writeFileSync('./testp',"thread "+process.env.forkId+" has won a block!\n",{flag:'a'});
    ...
    function SetupBlockPolling(){
        ...
        console.log("Process forkId <>0 don't start block detect work!")
        if(process.env.forkId==0){
            console.log("Process forkId 0 start detect new block and broadcast!")
