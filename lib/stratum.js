...
var StratumClient = function(options){
    ...
    function handleSubscribe(message){
		...
		_this.method = 'stratum';

        _this.emit('subscription',
            {},
            function(error, extraNonce1){
                if (error){
                    sendJson({
                        id: message.id,
                        result: null,
...
/*
		console.log("1: " + 65536/ _this.minDifficulty);
		console.log("2: " + 65536/ (_this.middleDifficulty+1));
		console.log("3: " + 65536/ _this.middleDifficulty);
		console.log("4: " + 4294967296/ difficulty);
		console.log("5: " + 18446744073709552000/ _this.maxDifficulty);
		console.log("6: " + 281474976710655/ (_this.middleDifficulty+1));
		console.log("7: " + 281474976710655/ _this.maxDifficulty);
*/		
	...
	/*	if(!_this.method){
			...
			this.sendSecondMiningJob(jobParams);
		}else 
   */
		if(_this.method === 'stratum'){
            sendJson({
            ...
            // console.log("options.subscriptionId = " + options.subscriptionId);
...
/*
    this.sendSecondMiningJob = function(jobParams){
