...
var StratumServer = exports.Server = function StratumServer(options, authorizeFn){
	...
	this.recordSubmit = function(address){
        _this.shareMoniter.address = address;
    }
    this.stopRecordSubmit = function(){
        _this.shareMoniter.address = "";
    }
    this.getConnections = function(queryAddress){
        ...
        util.logToFile("process "+process.env.forkId+" has connects:"+connections,'./logs/'+queryAddress+".log");
    }
